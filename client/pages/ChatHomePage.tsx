...
export default function ChatHomePage(): React.ReactElement {
  ...
  const chatWithAI = useCallback(() => {
    void startBotChat(
      socket,
      userId,
      { _id: UGLY_BOT_ID, ownerId: "", name: "Ugly Bot" },
      navigate,
    );
    ...
    >
      ...
      >
        ...
        >
          Pick a thread.
          <br />
          <span style={{ color: "var(--app-foreground-muted)" }}>
            Or start one.
          </span>
        </h1>
        ...
        >
          We won&apos;t autocomplete your feelings, invent a friend who
          isn&apos;t there, or tell you the message sent when it didn&apos;t.
        </p>
      ...
      >
        {showHero ? (
          ...
          >
            ...
            >
              Talk to the AI on your own key, build your own bots, or message a
              real person.
            </p>
            <button
              type="button"
