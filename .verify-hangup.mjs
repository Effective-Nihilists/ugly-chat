...
const rings = (p) =>
  p.evaluate(() => document.body.innerText.includes("INCOMING VIDEO CALL"));
...
console.log(
  "in call; bot on stage:",
  await a.p.locator('[data-id="call-tile-peer"]').count(),
);
